...
<hr style="width: 50%; height: 4px; background-color: #86b300; border: none; margin: 20px auto;">
    ...
    <form method="POST" action="/stock/scanin">
        @csrf
...
<br />
<hr style="width: 50%; height: 4px; background-color: #86b300; border: none; margin: 20px auto;">
    <form method="POST" action="{{ url('/stock/scaninsave') }}">
    @csrf
    <button type="submit" id="saveButton" class="btn btn-success">Send on Stock</button>
</form>
<hr style="width: 50%; height: 4px; background-color: #86b300; border: none; margin: 20px auto;">
    </center>
    <script>
